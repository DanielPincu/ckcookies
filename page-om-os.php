<?php get_header();?>
<section class="orange relative h-52 xl:h-64 mb-10 xl:mb-44">
...
<article class="container m-auto px-2 xl:px-0 flex flex-col lg:grid lg:grid-cols-2">
    ...
    <div class="order-2 lg:order-1">
        <h1 class="lg:text-3xl text-red-950 pb-10">Fra Hobby til Sød Eventyr</h1>
        <p class="lg:text-xl text-red-950">
...
<section class="orange h-[500px] relative lg:mt-32 mt-10">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div class="flex flex-col mx-auto items-center xl:items-start h-full px-10 xl:px-0">
            ...
            <div class="z-10 ">
                <p class="z-10 text-slate-100 md:w-full xl:w-3/4">Hos os er en cookie ikke bare en cookie – det er en lille bid af glæde, skabt med kærlighed og kreativitet. Uanset om du fejrer en særlig begivenhed eller bare vil forkæle dig selv, sørger vi for, at hver eneste bid er en oplevelse i sig selv. Lad os gøre dine søde øjeblikke endnu mere magiske! 🍪✨</p>
            </div>
